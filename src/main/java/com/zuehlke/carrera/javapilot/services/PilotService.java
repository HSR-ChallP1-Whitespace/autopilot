...
public class PilotService {
	...
	@Autowired
	public PilotService(PilotProperties settings, EndpointService endpointService, SimulatorService simulatorService) {
	...
	public void connectToRelay() {
		PilotToRelayConnection pilotToRelayConnection = new PilotToRelayStompConnection(settings.getRelayUrl(), settings.getName(), "admin", "admin",
				(startMessage) -> pilotActor.tell(startMessage, pilotActor), (stopMessage) -> pilotActor.tell(stopMessage, pilotActor),
				(sensorEvent) -> pilotActor.tell(sensorEvent, pilotActor), (velocityMessage) -> pilotActor.tell(velocityMessage, pilotActor),
